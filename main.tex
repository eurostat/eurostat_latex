...
% Here you can choose the color theme of the document, see Eurostat Graphical style guide for details about which one you have to choose : https://ec.europa.eu/eurostat/web/products-eurostat-news/-/STYLE-GUIDE_2016
...
\newcommand{\Articletitle}{\mbox{Eurostat} {\LaTeX} Style Sheet} % Cover, title, footer (put long words in \mbox{} to avoid hyphenation
...
%------------------------- Cover ------------------------
% cover
\include{template_material/cover}
% blank page
\newpage \thispagestyle{empty} \mbox{} 
%------------------------- Title page ------------------------
% title page
\newpage 
\include{template_material/title_page}
%------------------------- Copyright page ------------------------
\newpage
\include{template_material/copyright_page}
%------------------------- Pagestyle ------------------------
%Keep this before the first section of your article and after the copyright page.
% header
...
\begin{boxe3}{Section numbering in headers}
    ...
    \par In addition use \cs{mbox\{\}} in the title and section headers for long words to avoid hyphenation. 
\end{boxe3}
